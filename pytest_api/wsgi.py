...
class Specification(object):
    _specification = {
        ...
        "info": {
            "title": "WSGI API's",
            "description": "Swagger specification for documenting WSGI API's",
            "version": "0.0.1",
        },
    ...
    def dump_static_yaml(self):
        ...
        filename = Path(self.app.config["SPECIFICATION_PATH"])
    ...
    def responses(self):
        self._response_data = self.decode()
...
class WSGIMiddleware(Specification):
    ...
    def init_app(self, app=None):
        ...
        Specification.__init__(self, app)
